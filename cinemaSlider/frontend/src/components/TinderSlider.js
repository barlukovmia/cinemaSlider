...
const TinderSlider = () => {
  const [cards, setCards] = useState([
    ...
    { id: 4, name: 'МАМЕ СНОВА 17', link:'https://start.ru/watch/mame-snova-17', image: './images/p1192x597.webp', imageBack: './images/mamesnova.jpg', description: 'В школьную директрису вселяется безбашенная девица из 2000-х. Светлана Ходченкова в ироничной комедии о девушке-подростке, застрявшей в теле чопорной директрисы школы'},
    { id: 5, name: 'БЕЗ ГРАНИЦ', link:'https://start.ru/watch/bez-granic', image: './images/maxresdefault (1).jpg', imageBack: '.images/8081972-4943118.jpg', description: 'События картины начинаются в московском аэропорту, откуда главные герои отправляются в захватывающие путешествия к живописным горным долинам Армении, утопающим в зелени улочкам Тбилиси и праздничным огням новогодней Москвы '},
    { id: 6, name: '' },
    { id: 7, name: '' },
    { id: 8, name: '' },
    { id: 9, name: '' },
