...
const TinderSlider = () => {
  const [cards, setCards] = useState([
    ...
    { id: 8, name: 'МНОГОЭТАЖКА', genre:'триллер', image: './images/Без названия (1).jpg', description:'После исчезновения дочери в подъезде собственного дома герой начинает свое расследование', imageBack:'./images/JKxT-ot9mO1LvjM_8jnNguuj98cmgj8hILXChiNsyw3DT0NPSvolBQSkyDqiKjZktciM-zGywN5Ns0YYd4bgYBWlGsvuAdCwIutLZ5IspMr6mtq3I5ZGAG2ltstiFbexA--L6oJi2aWEFU03ozJXKcy9jf8E2-.webp' }
  ]);
